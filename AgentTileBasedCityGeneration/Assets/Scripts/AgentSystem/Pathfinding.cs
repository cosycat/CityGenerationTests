...
namespace AgentSystem {
    public class Pathfinding {
        private static readonly List<(int i, int j)>[] kMaskCached = new List<(int i, int j)>[16];
        ...
        /// </summary>
        public Waypoint? StartPosition { get; private set; }
        ...
        private Waypoint GetWaypoint(Vector2 pos) {
            ...
            if (streetGraph.TryFindClosestEdge(pos, out var edge, out var posOnEdge, parameters.SnapFactorEdge))
        ...
        public struct Waypoint {
            ...
            public Waypoint(IStreetNode node) : this(node.Position, node) { }
