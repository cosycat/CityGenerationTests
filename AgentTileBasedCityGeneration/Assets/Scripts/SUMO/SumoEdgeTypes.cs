...
namespace SUMO {
    ...
    public class SumoEdgeTypes {
        ...
        /// <summary>
        ///     A number, which determines the priority between different road types. netconvert derives the right-of-way rules at
        ///     junctions from the priority. The number starts with one; higher numbers represent more important roads.
        /// </summary>
