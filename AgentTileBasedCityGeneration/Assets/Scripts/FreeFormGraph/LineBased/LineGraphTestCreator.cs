...
namespace FreeFormGraph.LineBased {
    public static class LineGraphTestCreator {
        ...
        public static LineGraph GenerateHShapedGraph() {
            ...
            // Left Side
            graph.CreateEdge(nLeftBottom, new Vector3(0, 100, 0), out var e0, out var nLeftMiddle, out var isToNodeNew, out var isEdgeNew);
            graph.CreateEdge(nLeftMiddle, new Vector3(0, 200, 0), out var e1, out var nLeftTop, out var isToNodeNew1, out var isEdgeNew1);
            
            // Middle
            graph.CreateEdge(nLeftMiddle, new Vector3(100, 100, 0), out var e2, out var nRightMiddle, out var isToNodeNew2, out var isEdgeNew2);
            
            // Right Side
            graph.CreateEdge(nRightMiddle, new Vector3(100, 200, 0), out var e3, out var nRightTop, out var isToNodeNew3, out var isEdgeNew3);
            graph.CreateEdge(nRightMiddle, new Vector3(100, 0, 0), out var e4, out var nRightBottom, out var isToNodeNew4, out var isEdgeNew4);
