...
namespace Utils {
    public class CameraHandler : MonoBehaviour {
        ...
        private void Start() {
            ...
            simulationManager = FindObjectOfType<SimulationManager>() ?? throw new Exception("No SimulationManager found in scene.");
        ...
        private void OnPlayerVehicleChanged(Vehicle? newPlayerVehicle) {
            ...
            foreach (var cam in newPlayerVehicle.VehicleCameras) {
                allCameras.Add(cam);
            }
